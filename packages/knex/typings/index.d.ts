...
export declare namespace Knex {
  ...
  interface ChainableInterface<T = any>
    ...
    pipe<T extends import("stream").Writable>(
      writable: T,
      options?: Readonly<{ [key: string]: any }>
    ): stream.PassThrough;
  ...
  interface MySql2ConnectionConfig extends MySqlConnectionConfig {
    ...
    passwordSha1?: string;
    rowsAsArray?: boolean;
    stream?: boolean | ((opts: any) => import('stream').Stream) | import('stream').Stream;
    uri?: string;
  }
  ...
  interface FunctionHelper {
    ...
    uuidToBin(uuid: string, ordered?: boolean): Class_Buffer;
    binToUuid(bin: Class_Buffer, ordered?: boolean): string;
  }
